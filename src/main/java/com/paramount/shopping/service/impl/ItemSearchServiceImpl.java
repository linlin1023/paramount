...
public class ItemSearchServiceImpl implements ItemSearchService {
	...
	private Map searchList(Map searchMap){
		...
		highlightOptions.setSimplePrefix("");//前缀
		highlightOptions.setSimplePostfix("");
		query.setHighlightOptions(highlightOptions);//为查询对象设置高亮选项

		//1.1 关键字查询
		Criteria criteria=new Criteria("item_keywords").contains(String.valueOf(searchMap.get("keywords")));
		...
		//高亮入口集合(每条记录的高亮入口)
		List<HighlightEntry<TbItem>> entryList = page!=null?page.getHighlighted():new ArrayList<>();
